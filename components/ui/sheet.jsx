...
// added -> "x" icon in hamburger menu
        ...
        <SheetPortal>
            ...
            <SheetPrimitive.Content
                ...
                className={cn(
                    ...
                    side === "right" &&
                        "data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right inset-y-0 right-0 h-full w-3/4 sm:max-w-sm", // removed "border-l"
                    side === "left" &&
